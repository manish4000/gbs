@extends('layouts.app', ['activePage' => 'skill', 'titlePage' => __('Skills')])
...
<div class="content">
  <div class="container-fluid">
    ...
    <ol class="breadcrumb bg-white d-flex justify-content-start  ">
      ...
      <li><a href="#" class="text-decoration-none text-reset ms-1">Skills</a></li>
    </ol>
    ...
    <button type="button" class="btn btn-success mb-2" data-toggle="modal" data-target="#add_testimonial">Add New Skill</button>
    <div class="row">
      <div class="col-md-12">
        <div class="card">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="width: 250px">
                            <a href="{{route('admin.skill.status',$data->id)}}" class="btn btn-warning btn-sm" >Status</a>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
                ...
                <div class="container" >
                  <form action="{{route('admin.skill.store')}}"  method="POST" id="testimonial_create">
                      @csrf
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
                ...
                <div class="container" >
                  <form action="{{route('admin.skill.store')}}"  method="POST" id="update_testimonial" enctype="multipart/form-data">
                      @csrf
...
<script>
      ...
      $(document).on('click','.edit_testimonial',function(e){
        ...
        console.log(testimonial_id);
          ...
          url:  "{{APP_PATH}}" + "admin/skill/edit/"+testimonial_id,
          ...
          success:function(response){
              ...
              if(response.status == 404){
                ...
                Swal.fire(
                 ...
                 $('#edit_title').val(response.skill_data.title);
                 $('#edit_is_active').val(response.skill_data.is_active);
...
//on click on delete button 
      ...
      $(document).on('click','.delete_testimonial_btn',function(e){
          ...
          $.ajax({
            ...
            type:"DELETE",
            url: "{{APP_PATH}}"+"admin/skill/delete/"+delete_testimonial_id,
