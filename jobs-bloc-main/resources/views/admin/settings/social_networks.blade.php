@extends('layouts.app', ['activePage' => 'testimonial', 'titlePage' => __('Map')])
...
<div class="content">
  <div class="container-fluid">
    ...
    <ol class="breadcrumb bg-white d-flex justify-content-start  ">
      ...
      <li><a href="#" class="text-decoration-none text-reset ms-1">Social Network</a></li>
    </ol>
    <button type="button" class="btn btn-success mb-2" data-toggle="modal" data-target="#add_testimonial">Add New Social Network</button>
    <div class="row">
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-body">
            <div class="table-responsive">
              <table class="table">
                ...
                @if (isset( $social_networks_data))
  
                <tbody>
               
              
      
                      @foreach ($social_networks_data as $data)
                    <tr>
                        <td>{{ $data->id }}</td>
                        ...
                        <td  style="width: 220px;">
                            ...
                            <a href="{{route('admin.settings.social_network.status',$data->id)}}" class="btn btn-warning btn-sm" >Status</a>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Add New Network</h5>
        <button type="button" class="btn-close" data-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">                    
                <div class="container" >
                  <form action="{{route('admin.settings.social_network.store')}}"  method="POST" id="testimonial_create" enctype="multipart/form-data">
                      @csrf
...
<div class="modal fade" id="edit_testimonial" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Edit New Network </h5>
        <button type="button" class="btn-close" data-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
                ...
                <div class="container" >
                  <form action="{{route('admin.settings.social_network.update')}}"  method="POST" id="update_testimonial" enctype="multipart/form-data">
                      @csrf
...
<script>
      ...
      $(document).on('click','.edit_testimonial',function(e){
        ...
        console.log(testimonial_id);
          ...
          url:  "{{APP_PATH}}" + "admin/settings/social-network/edit/"+testimonial_id,
          ...
          success:function(response){
              ...
              if(response.status == 404){
                ...
                Swal.fire(
                 ...
                 $('#edit_title').val(response.social_network_data.title);
...
//on click on delete button 
      ...
      $(document).on('click','.delete_testimonial_btn',function(e){
          ...
          $.ajax({
            ...
            type:"DELETE",
            url: "{{APP_PATH}}"+"admin/settings/social-network/delete/"+delete_testimonial_id,
