  ...
  <div class="container-fluid">
    ...
    @endif
                  ...
                  <div class="container bg-white p-4" >
                    <form action="{{route('admin.job.submit_job.store')}}"  method="POST" id="create_job" enctype="multipart/form-data">
                        @csrf
                      ...
                      <select name="skill_id[]" id="skill-select" class="form-control " multiple required> 
                      ...
                      <div class="form-group">
                        ...
                        <label class="mb-4" for=""></label>
                        <textarea name="address"  class="form-control mt-3" id="editor1" cols="30" rows="5" placeholder="address"></textarea>
