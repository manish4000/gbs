@extends('layouts.app', ['activePage' => 'applications', 'titlePage' => __('Job Applications')])
...
<div class="content">
  <div class="container-fluid">
    ...
    <ol class="breadcrumb bg-white d-flex justify-content-start  ">
      ...
      <li><a href="#" class="text-decoration-none text-reset ms-1">Job Application </a></li>
    </ol>
      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header card-header-primary">
            ...
            <p class="card-category"> Here is a the job applications submit by user </p>
          </div>
          <div class="card-body">
            <div class="table-responsive">
              <table class="table">
                ...
                @if (isset( $job_applications))
  
                <tbody>
               
              
      
                      @foreach ($job_applications as $data)
                    <tr>
                        <td>{{ $data->id }}</td>
              ...
              {{$job_applications->links('pagination::bootstrap-4')}}
            </div>
          </div>
        </div>
      </div>
